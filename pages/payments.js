...
import payPalIcon from "../public/PayPalCard.png";
...
const Payments = () => {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" />
        ...
        <div className="mb-3 flex -mx-2">
            <div className="px-2">
                <label forHtml="type1" className="flex items-center cursor-pointer">
                    <input type="radio" className="form-radio h-5 w-5 text-indigo-500 mx-2" name="type" id="type1" checked />
                    <Image src={paymentIcon} width={200} height={30} alt=''/>
                </label>
            </div>
            <div className="px-2">
                <label forHtml="type2" className="flex items-center cursor-pointer">
                    <input type="radio" className="form-radio h-5 w-5 text-indigo-500 mx-2" name="type" id="type2" />
                    <Image src={payPalIcon} width={50} height={37} alt=''/>
                </label>
            </div>
        </div>
        <div className="mb-3">
